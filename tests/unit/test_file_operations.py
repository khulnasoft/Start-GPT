"""
This set of unit tests is designed to test the file operations that startGPT has access to.
"""
...
import startgpt.commands.file_operations as file_ops
from startgpt.config import Config
from startgpt.memory.vector.memory_item import MemoryItem
from startgpt.memory.vector.utils import Embedding
from startgpt.utils import readable_file_size
...
def test_download_file(config, workspace: Workspace):
    url = "https://github.com/khulnasoft/Start-GPT/archive/refs/tags/v0.2.2.tar.gz"
    local_name = workspace.get_path("start-gpt.tar.gz")
    size = 365023
    ...
    url = "https://github.com/khulnasoft/Start-GPT/archive/refs/tags/v0.0.0.tar.gz"
