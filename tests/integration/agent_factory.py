...
from startgpt.memory.vector import NoMemory, get_memory
...
def browser_agent(agent_test_config, memory_none: NoMemory, workspace: Workspace):
    ...
    command_registry.import_commands("startgpt.commands.web_selenium")
    command_registry.import_commands("startgpt.app")
    command_registry.import_commands("startgpt.commands.task_statuses")
