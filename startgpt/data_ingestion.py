...
from startgpt.file_operations import ingest_file, search_files
...
def configure_logging():
    ...
    return logging.getLogger("StartGPT-Ingestion")
...
def main() -> None:
    ...
    if args.file:
        ...
        print(
            "Please provide either a file path (--file) or a directory name (--dir) inside the start_gpt_workspace directory as input."
        )
