    ...
    def __init__(self, cfg):
        ...
        try:
            ...
            logger.double_check(
                ...
                + f"You can check out {Fore.CYAN + Style.BRIGHT}https://github.com/khulnasoft/Start-GPT#redis-setup{Style.RESET_ALL} to ensure you've set up everything correctly."
            )
            exit(1)
