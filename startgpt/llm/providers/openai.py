...
def retry_api(
    ...
    api_key_error_msg = (
        ...
        f"read more here: {Fore.CYAN}https://docs.sgpt.khulnasoft.com/setup/#getting-an-api-key{Fore.RESET}"
    )
    backoff_msg = (
...
class OpenAIFunctionSpec:
    """Represents a "function" in OpenAI, which is mapped to a Command in Start-GPT"""
