...
from startgpt.llm.utils import check_model
from startgpt.logs import logger
from startgpt.memory.vector import get_supported_memory_backends
...
def create_config(
    ...
    Args:
        ...
        allow_downloads (bool): Whether to allow Start-GPT to download files natively
    ...
    if allow_downloads:
        ...
        logger.typewriter_log(
            "WARNING: ",
            Fore.YELLOW,
            f"{Back.LIGHTYELLOW_EX}Start-GPT will now be able to download and save files to your machine.{Back.RESET} "
